...
- (void)sendPageviewWithLocalmap:(NSDictionary<NSString *, NSString *> * _Nonnull)localmap;
...
- (void)getCategoryListwithAPIWithCategory_callback:(SWIFT_NOESCAPE void (^ _Nonnull)(NSArray<NSString *> * _Nonnull))category_callback;
...
@property (nonatomic, copy) NSString * _Nullable updateId;
...
@property (nonatomic, copy) NSString * _Nullable timeoutDate;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
